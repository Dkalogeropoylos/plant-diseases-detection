...
base_estimator.fit(validation_pred_probs, validation_true_labels)

validation_calibrator = CalibratedClassifierCV(base_estimator, method='sigmoid', cv='prefit')


validation_calibrator.fit(validation_pred_probs, validation_true_labels)

test_pred_probs = model.predict(test_generator)

calibrated_test_probs = validation_calibrator.predict_proba(test_pred_probs)
...
calibrated_test_probs_isotonic = np.column_stack((
    isotonic_regressor.predict(test_pred_probs[:, 0]),
    isotonic_regressor.predict(test_pred_probs[:, 1]),
    isotonic_regressor.predict(test_pred_probs[:, 2])
))
